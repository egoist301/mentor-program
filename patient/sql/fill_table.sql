insert into patients(first_name, last_name, middle_name, phone_number, date_of_birth, create_date, update_date)
values ('Yauheni', 'Filipovich', 'Aleksandrovich', 3221114, '2000-08-27', current_date, current_date),
...
insert into illness(name, name_in_latin, chance_to_die, create_date, update_date)
